...
var MicrosoftGraph = (function (e) {
        ...
        function r() {
            ...
            function h(e, t, r, n) {
                var i = t && t.prototype instanceof x ? t : x,
                    ...
                    a = new L(n || []);
                return s(o, "_invoke", { value: P(e, r, a) }), o;
            }
            function p(e, t, r) {
                try {
            ...
            function P(e, t, r) {
                ...
                return function (o, a) {
                    ...
                    for (r.method = o, r.arg = a; ;) {
                        ...
                        var c = p(e, t, r);
                        if ("normal" === c.type) {
                            if (((i = r.done ? g : y), c.arg === w)) continue;
            ...
            function C(e, t) {
                ...
                if ("throw" === o.type)
                    return (t.method = "throw"), (t.arg = o.arg), (t.delegate = null), w;
                var a = o.arg;
                return a
                    ? a.done
                ...
                (i.mark = function (e) {
                    return (
                        Object.setPrototypeOf
                            ...
                            : ((e.__proto__ = E), f(e, d, "GeneratorFunction")),
    ...
    var m = (function () {
        function e(r) {
            if ((t(this, e), (this.requests = new Map()), void 0 !== r)) {
                var n = e.requestLimit;
                if (r.length > n) {
                    var i = new Error(
                        "Maximum requests limit exceeded, Max allowed number of requests are ".concat(
                            n
                        )
                    );
                    throw ((i.name = "Limit Exceeded Error"), i);
                }
                var o,
                    a = v(r);
                try {
                ...
                [
                    {
                        ...
                        value: function (t) {
                            ...
                            if ("" === t.id) {
                                var n = new Error(
                                    "Id for a request is empty, Please provide an unique id"
                                );
                            ...
                            if (this.requests.has(t.id)) {
                                var o = new Error(
                                    "Adding request with duplicate id ".concat(
                                        t.id,
                                        ", Make the id of the requests unique"
                                    )
                                );
                                throw ((o.name = "Duplicate RequestId Error"), o);
                            }
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            for (
                                var t = this.requests.delete(e),
                                r = this.requests.entries(),
                                n = r.next();
                                !n.done;
                                            ...
                                            for (; ;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        ...
                                                        throw (
                                                            (((a = new Error(
                                                                "No requests added yet, Please add at least one request."
                                                            )).name = "Empty Payload"),
                                                                a)
                                                        );
                                                    case 8:
                                                    ...
                                                    case 16:
                                                        if (
                                                            void 0 === (c = t.sent).body ||
                                                            (void 0 !== c.headers &&
                                                                void 0 !== c.headers["content-type"])
                                                        ) {
                                                            t.next = 21;
                                                            break;
                                                        }
                                                        throw (
                                                            (((l = new Error(
                                                                "Content-type header is not mentioned for request #".concat(
                                                                    u.id,
                                                                    ", For request having body, Content-type header should be mentioned"
                                                                )
                                                    ...
                                                    case 21:
                                                        (c.id = u.id),
                                                            void 0 !== u.dependsOn &&
                                                            u.dependsOn.length > 0 &&
                                                            (c.dependsOn = u.dependsOn),
                                                            r.push(c),
                                                            (o = i.next()),
                                                            (t.next = 12);
                                                        break;
                                                    case 27:
                                                        return (n.requests = r), t.abrupt("return", n);
                                                    case 29:
                                                    case "end":
                                                        return t.stop();
                                                }
                        ...
                        value: function (e, t) {
                            if (!this.requests.has(e)) {
                                var r = new Error(
                                    "Dependent ".concat(
                                        e,
                                        " does not exists, Please check the id"
                                    )
                                );
                            ...
                            if (void 0 !== t) {
                                ...
                                if (
                                    (void 0 === i.dependsOn && (i.dependsOn = []),
                                        -1 !== i.dependsOn.indexOf(t))
                                ) {
                                    var o = new Error(
                                        "Dependency "
                                            .concat(t, " is already added for the request ")
                                            .concat(e)
                                    );
                                    throw ((o.name = "Duplicate Dependency"), o);
                                }
                                i.dependsOn.push(t);
                            } else {
                                for (
                                    var a, s = this.requests.entries(), u = s.next();
                                    !u.done && u.value[1].id !== e;

                                )
                                    (a = u), (u = s.next());
                                if (void 0 === a) {
                                    var c = new Error(
                                        "Can't add dependency ".concat(
                                            t,
                                            ", There is only a dependent request in the batch"
                                        )
                                    );
                                ...
                                var l = a.value[0];
                                if (
                                    (void 0 === u.value[1].dependsOn &&
                                        (u.value[1].dependsOn = []),
                                        -1 !== u.value[1].dependsOn.indexOf(l))
                                ) {
                                    var d = new Error(
                                        "Dependency "
                                            .concat(l, " is already added for the request ")
                                            .concat(e)
                                    );
                                    throw ((d.name = "Duplicate Dependency"), d);
                                }
                ...
                [
                    {
                        ...
                        value: function (e) {
                            if (0 === e.size) {
                                var t = new Error(
                                    "Empty requests map, Please provide at least one request."
                                );
                            ...
                            return (
                                ...
                                (function (e) {
                                    ...
                                    for (r = t.next(); !r.done;) {
                                        ...
                                        if (
                                            void 0 === o.dependsOn ||
                                            1 !== o.dependsOn.length ||
                                            o.dependsOn[0] !== i.value[1].id
                                        )
                                            return !1;
                                        (i = r), (r = t.next());
                                    }
                                ...
                                (function (e) {
                                    ...
                                    if (void 0 === i.dependsOn || 0 === i.dependsOn.length)
                                        ...
                                        if (1 !== i.dependsOn.length) return !1;
                                        var o = i.dependsOn[0];
                                        if (o === i.id || !e.has(o)) return !1;
                                        t = o;
                                    }
                                    for (n = r.next(); !n.done;) {
                                        var a = n.value[1];
                                        if (
                                            (void 0 === a.dependsOn || 0 === a.dependsOn.length) &&
                                            t !== a.id
                                        )
                                            return !1;
                                        if (void 0 !== a.dependsOn && 0 !== a.dependsOn.length) {
                                            if (
                                                1 === a.dependsOn.length &&
                                                (a.id === t || a.dependsOn[0] !== t)
                                            )
                                                return !1;
    ...
    var g = (function () {
        function e(r) {
            t(this, e), (this.responses = new Map()), this.update(r);
        }
        return (
            o(e, [
                {
                            ...
                            function (e) {
                                for (; ;)
                                    switch ((e.prev = e.next)) {
                                        case 0:
                                            (t = this.responses.entries()), (r = t.next());
                                        case 2:
                                            if (r.done) {
                                                e.next = 8;
                                                break;
                                            }
                                            return (e.next = 5), r.value;
                                        case 5:
                                            (r = t.next()), (e.next = 2);
                                            break;
                                        case 8:
    ...
    var S = (function (e) {
            ...
            o(n, null, [
                {
                    ...
                    value: function (e) {
                        var t;
                        return (
                            e instanceof Error ? (t = e) : ((t = new n()).customError = e),
                            t
                        );
                    },
                },
        ...
        L = function (e) {
            ...
            if (-1 !== (e = e.toLowerCase()).indexOf("https://")) {
                ...
                if (-1 !== n)
                    return -1 !== r && r < n
                        ? ((i = e.substring(0, r)), t.has(i))
                        : ((i = e.substring(0, n)), t.has(i));
            }
            return !1;
        },
        M = function (e) {
            if (-1 !== e.indexOf("/"))
                throw new S(
                    "Please add only hosts or hostnames to the CustomHosts config. If the url is `http://example.com:3000/`, host is `example:3000`"
                );
        };
    function U(e, t) {
        var r =
    ...
    var q = (function () {
        function e() {
            ...
            t(this, e), (this.middlewareOptions = new Map());
            var n,
                i = U(r);
            try {
                for (i.s(); !(n = i.n()).done;) {
    ...
    var F,
        ...
        B = function (e, t, r, n) {
            if ("undefined" != typeof Request && e instanceof Request)
                ...
                if (void 0 === t.headers) t.headers = new Headers(I({}, r, n));
                ...
                } else Object.assign(t.headers, I({}, r, n));
        },
        Q = function (e, t, r, n) {
            "undefined" != typeof Request && e instanceof Request
                ? e.headers.append(r, n)
                : void 0 !== t &&
                (void 0 === t.headers
                    ? (t.headers = new Headers(I({}, r, n)))
                    : "undefined" != typeof Headers && t.headers instanceof Headers
                        ? t.headers.append(r, n)
                        : t.headers instanceof Array
                            ? t.headers.push([r, n])
                            : void 0 === t.headers
                                ? (t.headers = I({}, r, n))
                                : void 0 === t.headers[r]
                                    ? (t.headers[r] = n)
                                    : (t.headers[r] += ", ".concat(n)));
        },
        V = function (e, t) {
            return p(
                void 0,
    ...
    (e.FeatureUsageFlag = void 0),
        ((F = e.FeatureUsageFlag || (e.FeatureUsageFlag = {}))[(F.NONE = 0)] =
            "NONE"),
        (F[(F.REDIRECT_HANDLER_ENABLED = 1)] = "REDIRECT_HANDLER_ENABLED"),
        (F[(F.RETRY_HANDLER_ENABLED = 2)] = "RETRY_HANDLER_ENABLED"),
        (F[(F.AUTHENTICATION_HANDLER_ENABLED = 4)] =
            "AUTHENTICATION_HANDLER_ENABLED");
    var G = (function () {
        function r() {
            t(this, r), (this.featureUsage = e.FeatureUsageFlag.NONE);
        }
        return (
            o(
                r,
                ...
                [
                    {
                        ...
                        value: function (e, t) {
                            var n;
                            e.middlewareControl instanceof q
                                ? (n = e.middlewareControl.getMiddlewareOptions(r))
                                : (e.middlewareControl = new q()),
                                void 0 === n &&
                                ((n = new r()),
        ...
        $ = (function () {
            function r(e) {
                t(this, r), (this.authenticationProvider = e);
            }
            return (
                o(r, [
                    {
                                            ...
                                            for (; ;)
                                                switch ((n.prev = n.next)) {
                                                    case 0:
                                                        ...
                                                        return (
                                                            t.middlewareControl instanceof q &&
                                                            (o =
                                                                t.middlewareControl.getMiddlewareOptions(X)),
                                                            o &&
                                                            ((a = o.authenticationProvider),
                                                    ...
                                                    case 13:
                                                        t.options.headers &&
                                                            delete t.options.headers[r.AUTHORIZATION_HEADER];
                                                    case 14:
                                                        return (
                                                            (n.next = 16), this.nextMiddleware.execute(t)
                                                        );
                                                    case 16:
                            ...
                            h.mark(function t() {
                                return h.wrap(function (t) {
                                    for (; ;)
                                        switch ((t.prev = t.next)) {
                                            case 0:
                                                return (t.next = 2), fetch(e.request, e.options);
                                            case 2:
                                                e.response = t.sent;
                                            case 3:
                                            case "end":
                ...
                var r =
                    ...
                    i =
                        arguments.length > 2 && void 0 !== arguments[2]
                            ? arguments[2]
                            : e.defaultShouldRetry;
                if ((t(this, e), r > e.MAX_DELAY && n > e.MAX_MAX_RETRIES)) {
                    var o = new Error(
                        "Delay and MaxRetries should not be more than "
                            .concat(e.MAX_DELAY, " and ")
                            .concat(e.MAX_MAX_RETRIES)
                    );
                    throw ((o.name = "MaxLimitExceeded"), o);
                }
                if (r > e.MAX_DELAY) {
                    var a = new Error(
                        "Delay should not be more than ".concat(e.MAX_DELAY)
                    );
                    throw ((a.name = "MaxLimitExceeded"), a);
                }
                if (n > e.MAX_MAX_RETRIES) {
                    var s = new Error(
                        "MaxRetries should not be more than ".concat(e.MAX_MAX_RETRIES)
                    );
            ...
            o(r, [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        if (
                            (r === f.PUT || r === f.PATCH || r === f.POST) &&
                            "application/octet-stream" === j(e, t, "Content-Type")
                        )
                            return !1;
                        return !0;
                    },
                },
                {
                    ...
                    value: function (e, t, n) {
                        var i,
                            ...
                            a =
                                void 0 !== e.headers
                                    ? e.headers.get(r.RETRY_AFTER_HEADER)
                                    : null;
                        return (
                            (i =
                                null !== a
                                    ? Number.isNaN(Number(a))
                                        ? Math.round((new Date(a).getTime() - Date.now()) / 1e3)
                                        : Number(a)
                                    : t >= 2
                                        ? this.getExponentialBackOffTime(t) + n + o()
                                        : n + o()),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        return (
                            e.middlewareControl instanceof q &&
                            (t = e.middlewareControl.getMiddlewareOptions(
                                    ...
                                    function (i) {
                                        for (; ;)
                                            switch ((i.prev = i.next)) {
                                                case 0:
                                                    return (i.next = 2), this.nextMiddleware.execute(e);
                                                case 2:
                                                    if (
                                                        !(
                                                            t < n.maxRetries &&
                                                            this.isRetry(e.response) &&
                                                            this.isBuffered(e.request, e.options) &&
                                                            n.shouldRetry(
                                                                n.delay,
                                                                t,
                                                                e.request,
                                                ...
                                                case 8:
                                                    return (i.next = 10), this.executeWithRetry(e, t, n);
                                                case 10:
                                            ...
                                            switch ((r.prev = r.next)) {
                                                case 0:
                                                    return (
                                                        ...
                                                        G.updateFeatureUsageFlag(
                                                            t,
                                                            e.FeatureUsageFlag.RETRY_HANDLER_ENABLED
                                                        ),
                                                        (r.next = 5),
    ...
    var J = o(function e() {
        var r =
            arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : e.DEFAULT_MAX_REDIRECTS,
            n =
                arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : e.defaultShouldRedirect;
        if ((t(this, e), r > e.MAX_MAX_REDIRECTS)) {
            var i = new Error(
                "MaxRedirects should not be more than ".concat(e.MAX_MAX_REDIRECTS)
            );
        ...
        (this.maxRedirects = r), (this.shouldRedirect = n);
    });
            ...
            o(r, [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        var a = i.exec(t);
                        return (
                            null !== a && (n = a[0]), void 0 !== r && void 0 !== n && r !== n
                        );
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        return (
                            e.middlewareControl instanceof q &&
                            (t = e.middlewareControl.getMiddlewareOptions(J)),
                                        ...
                                        for (; ;)
                                            switch ((i.prev = i.next)) {
                                                ...
                                                case 2:
                                                    ...
                                                    if ((++t, o.status !== r.STATUS_CODE_SEE_OTHER)) {
                                                        i.next = 10;
                                                        break;
                                                    }
                                                ...
                                                case 10:
                                                    return (
                                                        (a = this.getLocationHeader(o)),
                                                        !this.isRelativeURL(a) &&
                                                        this.shouldDropAuthorizationHeader(o.url, a) &&
                                                        delete e.options.headers[r.AUTHORIZATION_HEADER],
                                                        (i.next = 14),
                                                        this.updateRequestUrl(a, e)
                                                    );
                                                case 14:
                                                    return (
                                                        (i.next = 16), this.executeWithRedirect(e, t, n)
                                                    );
                                                case 16:
                                                    i.next = 19;
                                                    break;
                                            ...
                                            switch ((n.prev = n.next)) {
                                                case 0:
                                                    return (
                                                        ...
                                                        G.updateFeatureUsageFlag(
                                                            t,
                                                            e.FeatureUsageFlag.REDIRECT_HANDLER_ENABLED
                                                        ),
                                                        (n.next = 6),
                                                    ...
                                                    return (
                                                        (n =
                                                            "string" == typeof t.request
                                                                ? t.request
                                                                : t.request.url),
                                                        _(n) || (t.customHosts && D(n, t.customHosts))
                                                            ? ((i = j(
                                                                t.request,
                                                                t.options,
                                                                e.CLIENT_REQUEST_ID_HEADER
                                                            )) ||
                                                                ((i = H()),
                                                                    B(
                                                                        t.request,
                                                                ...
                                                                t.middlewareControl instanceof q &&
                                                                (a =
                                                                    t.middlewareControl.getMiddlewareOptions(
                                                                        G
                                                                    )),
                                                                a &&
                                                                ((s = a.getFeatureUsage()),
                                                                    (o += " ("
                                                                        .concat(e.FEATURE_USAGE_STRING, "=")
                                                                        .concat(s, ")"))),
                                                                Q(
                                                                    t.request,
                                                                    t.options,
                                                                    e.SDK_VERSION_HEADER,
                                                                    o
                                                                ))
                                                            : (delete t.options.headers[
                                                                e.CLIENT_REQUEST_ID_HEADER
                                                            ],
    ...
    (e.ChaosStrategy = void 0),
        ((ee = e.ChaosStrategy || (e.ChaosStrategy = {}))[(ee.MANUAL = 0)] =
            "MANUAL"),
    ...
    var re,
        ...
        ce = (function () {
            function r() {
                ...
                t(this, r), (this.options = e), (this.manualMap = n);
            }
            return (
                o(r, [
                    {
                        ...
                        value: function (e, t, r) {
                            ...
                            return (
                                n.append("Cache-Control", "no-store"),
                            ...
                            e.statusCode >= 400
                                ? (n = {
                                    error: {
                                        ...
                                        innerError: { "request-id": t, date: r },
                                    },
                                })
                                : (n = {});
                            return n;
                                                    ...
                                                    case 0:
                                                        if (
                                                            (this.setStatusCode(
                                                                ...
                                                                !(
                                                                    (t.chaosStrategy === e.ChaosStrategy.MANUAL &&
                                                                        !this.nextMiddleware) ||
                                                        ...
                                                        this.createResponse(t, r), (n.next = 8);
                                                        break;
                                                    case 5:
                                                        ...
                                                        return (n.next = 8), this.nextMiddleware.execute(r);
                                                    case 8:
                                                    case "end":
                                                        return n.stop();
                                                }
                        ...
                        value: function (t, r, n) {
                            ...
                            if (t.chaosStrategy === e.ChaosStrategy.MANUAL) {
                                if (void 0 === t.statusCode) {
                                    ...
                                    void 0 !== this.manualMap.get(o)
                                        ? void 0 !== this.manualMap.get(o).get(n) &&
                                        (t.statusCode = this.manualMap.get(o).get(n))
                                        : this.manualMap.forEach(function (e, r) {
                                            new RegExp(r + "$").test(o) &&
                                                void 0 !== i.manualMap.get(r).get(n) &&
                                                (t.statusCode = i.manualMap.get(r).get(n));
                                        });
                                }
                            } else t.statusCode = this.getRandomStatusCode(n);
                        },
                    },
                    {
                        key: "getOptions",
                        value: function (e) {
                            ...
                            return (
                                e.middlewareControl instanceof q &&
                                (t = e.middlewareControl.getMiddlewareOptions(ae)),
    ...
    (e.ResponseType = void 0),
        ((re = e.ResponseType || (e.ResponseType = {})).ARRAYBUFFER =
            "arraybuffer"),
        (re.BLOB = "blob"),
    ...
    var le = (function () {
                                        ...
                                        switch ((i.prev = i.next)) {
                                            ...
                                            case 2:
                                                (a = t.headers.get("Content-type")),
                                                    (i.t0 = n),
                                                    (i.next =
                                                        i.t0 === e.ResponseType.ARRAYBUFFER
                                                            ? 6
                                                            : i.t0 === e.ResponseType.BLOB
                                                                ? 10
                                                                : i.t0 === e.ResponseType.DOCUMENT
                                                                    ? 14
                                                                    : i.t0 === e.ResponseType.JSON
                                                                        ? 18
                                                                        : i.t0 === e.ResponseType.STREAM
                                                                            ? 22
                                                                            : i.t0 === e.ResponseType.TEXT
                                                                                ? 26
                                                                                : 30);
                                                break;
                                            case 6:
                                                return (i.next = 8), t.arrayBuffer();
                                            case 8:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 10:
                                                return (i.next = 12), t.blob();
                                            case 12:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 14:
                                                return (
                                            ...
                                            case 16:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 18:
                                                return (i.next = 20), t.json();
                                            case 20:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 22:
                                                return (i.next = 24), Promise.resolve(t.body);
                                            case 24:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 26:
                                                return (i.next = 28), t.text();
                                            case 28:
                                                return (o = i.sent), i.abrupt("break", 59);
                                            case 30:
                                                if (null === a) {
                                                ...
                                                return (i.next = 35), r.parseDocumentResponse(t, s);
                                            case 35:
                                                (o = i.sent), (i.next = 55);
                                                break;
                                            case 38:
                                ...
                                return h.wrap(function (o) {
                                    for (; ;)
                                        switch ((o.prev = o.next)) {
                                            ...
                                            case 4:
                                                return (o.next = 6), r.convertResponse(t, n);
                                            case 6:
                                                if (((a = o.sent), !t.ok)) {
                                                    o.next = 15;
                                                    break;
        ...
        de = o(function e() {
            ...
            t(this, e), (this.minValue = r), (this.maxValue = n);
        }),
        fe = (function () {
            function e(r, n) {
                t(this, e), (this._location = n), (this._responseBody = r);
            }
            return (
                o(
                    e,
        ...
        he = (function () {
            function r(e, n, i) {
                ...
                if (
                    ...
                    throw new S(
                        "Please pass the FileUpload object, StreamUpload object or any custom implementation of the FileObject interface"
                    );
                (this.file = n),
                    (this.file = n),
                    ...
                    [
                        {
                            ...
                            value: function (e) {
                                var t = e[0];
                                if (void 0 === t || "" === t) return new de();
                                var r = t.split("-"),
                                    n = parseInt(r[0], 10),
                                    i = parseInt(r[1], 10);
                                return (
                                    Number.isNaN(i) && (i = this.file.size - 1), new de(n, i)
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return (
                                    t >= this.file.size && (t = this.file.size - 1), new de(e, t)
                                );
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                if (
                                    (console.warn(
                                        "The LargeFileUploadTask.sliceFile() function has been deprecated and moved into the FileObject interface."
                                    ),
                                        this.file.content instanceof ArrayBuffer ||
                                        this.file.content instanceof Blob ||
                                        this.file.content instanceof Uint8Array)
                                )
                                    return this.file.content.slice(e.minValue, e.maxValue + 1);
                                throw new S(
                                    "The LargeFileUploadTask.sliceFile() function expects only Blob, ArrayBuffer or Uint8Array file content. Please note that the sliceFile() function is deprecated."
                                );
                            },
                        },
                        {
                                                ...
                                                for (; ;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            t =
                                                                this.options &&
                                                                this.options.uploadEventHandlers;
                                                        case 1:
                                                        ...
                                                        case 7:
                                                            return (e.next = 9), this.file.sliceFile(r);
                                                        case 9:
                                                            return (
                                                                (i = e.sent),
                                                                (e.next = 12),
                                                                this.uploadSliceGetRawResponse(
                                                                    i,
                                                                    r,
                                                                    this.file.size
                                                                )
                                                        ...
                                                        case 12:
                                                            ...
                                                            throw new S(
                                                                "Something went wrong! Large file upload slice response is null."
                                                            );
                                                        case 15:
                                                            return (e.next = 17), le.getResponse(o);
                                                        case 17:
                                                            if (
                                                                ((a = e.sent),
                                                                    !(
                                                            ...
                                                            return (
                                                                ...
                                                                e.abrupt(
                                                                    "return",
                                                                    fe.CreateUploadResult(a, o.headers)
                                                                )
                                                            );
                                                        case 21:
                                                            (s = {
                                                                expirationDateTime:
                                                                    a.expirationDateTime || a.ExpirationDateTime,
                                                                nextExpectedRanges:
                                                                    a.NextExpectedRanges || a.nextExpectedRanges,
                                                            }),
                                                        ...
                                                        case 0:
                                                            return (
                                                                ...
                                                                this.client
                                                                    ...
                                                                    .responseType(e.ResponseType.RAW)
                                                                    .put(t)
                                                            );
                                                        case 2:
                                                            return i.abrupt("return", i.sent);
                                                ...
                                                for (; ;)
                                                    switch ((t.prev = t.next)) {
                                                        ...
                                                        case 2:
                                                            return (
                                                                204 === (r = t.sent).status &&
                                                                (this.uploadSession.isCancelled = !0),
                                                                t.abrupt("return", r)
                                                            );
                                                        case 5:
                                                        case "end":
                                    ...
                                    h.mark(function i() {
                                        ...
                                        return h.wrap(function (i) {
                                            for (; ;)
                                                switch ((i.prev = i.next)) {
                                                    case 0:
                                                        return (i.next = 2), e.api(t).headers(n).post(r);
                                                    case 2:
                                                        return (
                                                            (o = i.sent),
                                                            (a = {
    ...
    var ve = (function () {
        function e(r, n, i) {
            if (
                ...
                throw new S(
                    "Please provide the upload content, name of the file and size of the file"
                );
        }
        return (
            o(e, [
    ...
    var ge = (function (e) {
        ...
        var r = me(n);
        function n(e, i, o, a) {
            return t(this, n), r.call(this, e, i, o, a);
        }
        return (
            o(
                n,
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                "/me/drive/root:"
                                    ...
                                    .concat(encodeURIComponent(e), ":/createUploadSession")
                            );
                        },
                    },
                    {
                                            ...
                                            for (; ;)
                                                switch ((i.prev = i.next)) {
                                                    case 0:
                                                        ...
                                                        throw new S(
                                                            "Please provide the Graph client instance, file object and OneDriveLargeFileUploadOptions value"
                                                        );
                                                    case 2:
                                                        return (
                                                            (o = r.fileName),
                                                            ...
                                                            i.abrupt(
                                                                "return",
                                                                this.createTaskWithFileObject(e, s, r)
                                                            )
                                                        );
                                                    case 6:
                                                    case "end":
                                        ...
                                        for (; ;)
                                            switch ((i.prev = i.next)) {
                                                case 0:
                                                    ...
                                                    throw new S(
                                                        "Please provide the Graph client instance, FileObject interface implementation and OneDriveLargeFileUploadOptions value"
                                                    );
                                                case 2:
                                                    return (
                                                        (o = r.uploadSessionURL
                                                            ? r.uploadSessionURL
                                                            : n.constructCreateSessionUrl(
                                                                r.fileName,
                                                                r.path
                                                            )),
                                                        (a = {
                                                            ...
                                                            (i = {
                                                                item: {
                                                                    "@microsoft.graph.conflictBehavior":
                                                                        (null == r ? void 0 : r.conflictBehavior) ||
                                                                        "rename",
                                                                    name: null == r ? void 0 : r.fileName,
                                                                    description:
                                                                        null == r ? void 0 : r.fileDescription,
                                                                },
                                                            }),
                                                            n.abrupt(
                                                                "return",
                                                                o.createUploadSession.call(this, e, t, i)
                                                            )
                                                        );
                                                    case 2:
                                                    case "end":
                                        ...
                                        for (; ;)
                                            switch ((t.prev = t.next)) {
                                                case 0:
                                                    ...
                                                    if (
                                                        !(e.minValue < this.previousSlice.range.minValue)
                                                    ) {
                                                        t.next = 5;
                                                        break;
                                                    }
                                                    throw new S(
                                                        "An error occurred while uploading the stream. Please restart the stream upload from the first byte of the file."
                                                    );
                                                case 5:
                                                    if (
                                                        !(e.minValue < this.previousSlice.range.maxValue)
                                                    ) {
                                                        t.next = 14;
                                                        break;
                                                    }
                                                    if (
                                                        ((i = this.previousSlice.range.minValue),
                                                ...
                                                case 10:
                                                    ...
                                                    return t.abrupt(
                                                        "return",
                                                        this.previousSlice.fileSlice.slice(
                                                            e.minValue,
                                                            e.maxValue + 1
                                                        )
                                                    );
                                                ...
                                                case 14:
                                                    ...
                                                    n.push(this.content.read(r)), (t.next = 24);
                                                    break;
                                                case 19:
                                                    return (
                                                        (t.t0 = n),
                                                ...
                                                case 27:
                                                    return (
                                                        (a = Buffer.concat(n)),
                                                        (this.previousSlice = { fileSlice: a, range: e }),
                                                        t.abrupt("return", a)
                                                    );
                                                case 30:
                                                case "end":
                    ...
                    value: function (e) {
                        ...
                        return new Promise(function (r, n) {
                            ...
                            t.content.on("end", function () {
                                if (o > 0)
                                    return n(
                                        new S("Stream ended before reading required range size")
                                    );
                            }),
                                t.content.on("readable", function () {
                                    for (var s; a < e && null !== (s = t.content.read(o));)
                                        (a += s.length), i.push(s), o > 0 && (o = e - a);
                                    return a === e
                                        ? r(Buffer.concat(i))
                                        : t.content && t.content.readable
                                            ? void 0
                                            : n(
                                                new S(
                                                    "Error encountered while reading the stream during the upload"
                                                )
                                            );
                                });
                        });
                                        ...
                                        function (e) {
                                            for (; ;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            (t = this.client.api(this.nextLink)),
                                                            this.requestOptions &&
                                                            (this.requestOptions.headers &&
                                                                (t = t.headers(this.requestOptions.headers)),
                                                                this.requestOptions.middlewareOptions &&
                                                                (t = t.middlewareOptions(
                                                                    this.requestOptions.middlewareOptions
                                                                )),
                                                                this.requestOptions.options &&
                                                                (t = t.options(this.requestOptions.options))),
                                                            (e.next = 4),
                                                            t.get()
                                                        );
                                                    case 4:
                                            ...
                                            for (; ;)
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 1:
                                                        ...
                                                        return (
                                                            (e.next = 5), this.fetchAndUpdateNextPageData()
                                                        );
                                                    case 5:
                                                        (t = this.iterationHelper()), (e.next = 9);
                                                        break;
                                                    case 8:
                                                        t = !1;
                                                    case 9:
                                                                        ...
                                                                        for (; ;)
                                                                            switch ((t.prev = t.next)) {
                                                                                ...
                                                                                case 4:
                                                                                    return (
                                                                                        n ||
                                                                                        ("Access token is undefined or empty.\t\t\t\t\t\tPlease provide a valid token.\t\t\t\t\t\tFor more help - https://github.com/microsoftgraph/msgraph-sdk-javascript/blob/dev/docs/CustomAuthenticationProvider.md",
                                                                                            (n = new S(
                                                                                                "Access token is undefined or empty.\t\t\t\t\t\tPlease provide a valid token.\t\t\t\t\t\tFor more help - https://github.com/microsoftgraph/msgraph-sdk-javascript/blob/dev/docs/CustomAuthenticationProvider.md"
                                                                                            ))),
                                                                                        (t.next = 7),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, r) {
                            ...
                            return (
                                (i.code = n.code),
                                void 0 !== n.innerError &&
                                ((i.requestId = n.innerError["request-id"]),
                                        ...
                                        for (; ;)
                                            switch ((o.prev = o.next)) {
                                                case 0:
                                                    if (
                                                        (t && t.error
                                                            ? (a = e.constructErrorFromResponse(t, r, i))
                                                            : t instanceof Error
                                                                ? (a = e.constructError(t, r, i))
                                                                : ((a = new Oe(r)).body = t),
                                                            "function" != typeof n)
                                                    ) {
                                                        o.next = 5;
            ...
            t(this, n),
                (this.parsePath = function (e) {
                    if (-1 !== e.indexOf("https://")) {
                        ...
                        -1 !== t &&
                            ((o.urlComponents.host = "https://" + e.substring(0, t)),
                                (e = e.substring(t + 1, e.length)));
                        var r = e.indexOf("/");
                        -1 !== r &&
                            ((o.urlComponents.version = e.substring(0, r)),
                                (e = e.substring(r + 1, e.length)));
                    }
                    "/" === e.charAt(0) && (e = e.substr(1));
                    var n = e.indexOf("?");
                    if (-1 === n) o.urlComponents.path = e;
                    else {
                        o.urlComponents.path = e.substr(0, n);
                        var i,
                            a = Te(e.substring(n + 1, e.length).split("&"));
                        try {
                            for (a.s(); !(i = a.n()).done;) {
                                var s = i.value;
            ...
            o(n, [
                {
                    ...
                    value: function (e, t, r) {
                        this.urlComponents.oDataQueryParams[e] = this.urlComponents
                            .oDataQueryParams[e]
                            ? this.urlComponents.oDataQueryParams[e] + ","
                            : "";
                        var n = [];
                        r.length > 1 && "string" == typeof t
                    ...
                    value: function () {
                        ...
                        if (0 !== Object.keys(e.oDataQueryParams).length)
                            for (var r in e.oDataQueryParams)
                                Object.prototype.hasOwnProperty.call(e.oDataQueryParams, r) &&
                                    t.push(r + "=" + e.oDataQueryParams[r]);
                        if (0 !== Object.keys(e.otherURLQueryParams).length)
                            for (var n in e.otherURLQueryParams)
                                Object.prototype.hasOwnProperty.call(
                                    e.otherURLQueryParams,
                                    n
                                ) && t.push(n + "=" + e.otherURLQueryParams[n]);
                        if (0 !== e.otherURLQueryOptions.length) {
                            var i,
                                o = Te(e.otherURLQueryOptions);
                            try {
                                for (o.s(); !(i = o.n()).done;) {
                                    var a = i.value;
                                    t.push(a);
                        ...
                        if ("string" == typeof e)
                            ...
                            for (var i in e)
                                Object.prototype.hasOwnProperty.call(e, i) &&
                                    this.setURLComponentsQueryParamater(i, e[i]);
                        return this;
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        if (void 0 !== this.config.fetchOptions) {
                            ...
                            Object.assign(e, n),
                                void 0 !== r(this.config.fetchOptions.headers) &&
                                    ...
                                    function (i) {
                                        for (; ;)
                                            switch ((i.prev = i.next)) {
                                                case 0:
                                                    return (
                                                        (a = new q(this._middlewareOptions)),
                ...
                },
                {
                    ...
                    value: function () {
                        if (this._headers) {
                            for (
                                var e = 0, t = Object.keys(this._headers);
                                e < t.length;
                                e++
                            ) {
                ...
                },
                {
                    ...
                    value: function () {
                        var e =
                            ...
                            arguments[0];
                        return (
                            (this.urlComponents.oDataQueryParams.$count = e.toString()),
                            this
                        );
                    },
                },
                                ...
                                return h.wrap(
                                    function (r) {
                                        for (; ;)
                                            switch ((r.prev = r.next)) {
                                                case 0:
                                                    return (r.next = 2), this.patch(e, t);
                                                case 2:
                                                    return r.abrupt("return", r.sent);
                                                case 3:
                                                case "end":
        ...
        Ce = (function () {
            function e() {
                for (var r = arguments.length, n = new Array(r), i = 0; i < r; i++)
                    n[i] = arguments[i];
                if ((t(this, e), !n || !n.length)) {
                    var o = new Error();
                    throw (
                        ((o.name = "InvalidMiddlewareChain"),
                            (o.message =
                                "Please provide a default middleware chain or custom middleware chain"),
                            o)
                    );
                }
                                                    ...
                                                    case 0:
                                                        ...
                                                        throw (
                                                            (((r = new Error()).name =
                                                                ...
                                                                (r.message =
                                                                    "Unable to execute the middleware, Please provide valid options for a request"),
                                                                r)
                                                        );
                                                    case 5:
                                                        return (t.next = 7), this.middleware.execute(e);
                                                    case 7:
                ...
                o(e, null, [
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                var s = new Z(new J());
                                i.setNext(s), s.setNext(o);
                            } else i.setNext(o);
                            return o.setNext(a), e.createWithMiddleware(n);
                        },
                    },
                    {
        ...
        De = (function () {
            function e(r) {
                ...
                if (void 0 !== r.authProvider && void 0 !== r.middleware) {
                    var o = new Error();
                    throw (
                        ((o.name = "AmbiguityInInitialization"),
                            (o.message =
                                "Unable to Create Client, Please provide either authentication provider for default middleware chain or custom middleware chain not both"),
                            o)
                    );
                }
                if (void 0 !== r.authProvider)
                    ...
                    if (void 0 === r.middleware) {
                        var a = new Error();
                        throw (
                            ((a.name = "InvalidMiddlewareChain"),
                                (a.message =
                                    "Unable to Create Client, Please provide either authentication provider for default middleware chain or custom middleware chain"),
                                a)
                        );
                    }
                            ...
                            value: function (t) {
                                ...
                                for (var n in t)
                                    Object.prototype.hasOwnProperty.call(t, n) &&
                                        (r[n] = "authProvider" === n ? new ke(t[n]) : t[n]);
