	...
	return Controller.extend("zuniformes.controller.MainView", {
		...
		_loadFragments: function () {
			...
			var aFragmentNames = [
				...
				this._loadFragment("zuniformes.view.2_packages.2_1.PackageView"),
				this._loadFragment("zuniformes.view.2_packages.2_2.OperatorView"),
				this._loadFragment("zuniformes.view.2_packages.2_3.AspView"),
				this._loadFragment("zuniformes.view.3_inventory.InventoryView"),
				this._loadFragment("zuniformes.view.4_sizes.4_1.GralSizesView"),
				this._loadFragment("zuniformes.view.4_sizes.4_2.InvSizesView"),
				this._loadFragment("zuniformes.view.5_assignments.5_1.AssignmentsView"),
				this._loadFragment("zuniformes.view.5_assignments.5_2.AssigSizesView"),
				this._loadFragment("zuniformes.view.6_in_charge.InChargeView"),
				this._loadFragment("zuniformes.view.7_documents.7_1.InfoDocumentsView"),
				this._loadFragment("zuniformes.view.7_documents.7_2.DocumentsView"),
				this._loadFragment("zuniformes.view.8_rotations.8_1.RotationsView"),
				this._loadFragment("zuniformes.view.8_rotations.8_2.ChargeRotationsView"),
				this._loadFragment("zuniformes.view.9_users.9_1.UsersView"),
				this._loadFragment("zuniformes.view.9_users.9_2.RolesView"),
				this._loadFragment("zuniformes.view.9_users.9_3.PermissionsView"),
			];
		...
		onCreateDialogPaq: function () {
			...
			PackageControllerHelper.setFgtCreatePaq(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.2_packages.2_1.forms.CreateForm",
					"zuniformes.view.2_packages.2_1.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogPaq: function () {
			...
			PackageControllerHelper.setFgtUpdatePaq(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.2_packages.2_1.forms.UpdateForm",
					"zuniformes.view.2_packages.2_1.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedPaq: function () {
			this.createViewSettingsDialog("zuniformes.view.2_packages.2_1.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedPaq: function () {
			this.createViewSettingsDialog("zuniformes.view.2_packages.2_1.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogOpe: function () {
			...
			OperatorControllerHelper.setFgtCreateOpe(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.2_packages.2_2.forms.CreateForm",
					"zuniformes.view.2_packages.2_2.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogOpe: function () {
			...
			OperatorControllerHelper.setFgtUpdateOpe(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.2_packages.2_2.forms.UpdateForm",
					"zuniformes.view.2_packages.2_2.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedOpe: function () {
			this.createViewSettingsDialog("zuniformes.view.2_packages.2_2.dialogs.SortDialog").open();
		},
		...
		onCreateDialogAsp: function () {
			AspControllerHelper.setFtgCreateAsp(sap.ui.xmlfragment(
				this.getView().getId() + "-zuniformes.view.2_packages.2_3.nav.CreateNav",
				"zuniformes.view.2_packages.2_3.nav.CreateNav",
				this
			));
		...
		handleSortBtnPressedAsp: function () {
			this.createViewSettingsDialog("zuniformes.view.2_packages.2_3.dialogs.SortDialog").open();
		},
		...
		onStockDialogInv: function () {
			...
			InventoryControllerHelper.setFgtStockInv(sap.ui.xmlfragment(
				this.getView().getId() + "-zuniformes.view.3_inventory.forms.StockForm",
				"zuniformes.view.3_inventory.forms.StockForm",
				this
			));
		...
		onCreateDialogInv: function () {
			...
			InventoryControllerHelper.setFgtCreateInv(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.3_inventory.forms.CreateForm",
					"zuniformes.view.3_inventory.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogInv: function () {
			...
			InventoryControllerHelper.setFgtUpdateInv(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.3_inventory.forms.UpdateForm",
					"zuniformes.view.3_inventory.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedInv: function () {
			this.createViewSettingsDialog("zuniformes.view.3_inventory.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedInv: function () {
			this.createViewSettingsDialog("zuniformes.view.3_inventory.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogTaGral: function () {
			...
			GralSizesControllerHelper.setFgtCreateTaGral(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.4_sizes.4_1.forms.CreateForm",
					"zuniformes.view.4_sizes.4_1.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogTaGral: function () {
			...
			GralSizesControllerHelper.setFgtUpdateTaGral(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.4_sizes.4_1.forms.UpdateForm",
					"zuniformes.view.4_sizes.4_1.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedTaGral: function () {
			this.createViewSettingsDialog("zuniformes.view.4_sizes.4_1.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedTaGral: function () {
			this.createViewSettingsDialog("zuniformes.view.4_sizes.4_1.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogTaInv: function () {
			...
			InvSizesControllerHelper.setFgtCreateTaInv(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.4_sizes.4_2.forms.CreateForm",
					"zuniformes.view.4_sizes.4_2.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogTaInv: function () {
			...
			InvSizesControllerHelper.setFgtUpdateTaInv(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.4_sizes.4_2.forms.UpdateForm",
					"zuniformes.view.4_sizes.4_2.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedTaInv: function () {
			this.createViewSettingsDialog("zuniformes.view.4_sizes.4_2.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedTaInv: function () {
			this.createViewSettingsDialog("zuniformes.view.4_sizes.4_2.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogAsig: function () {
			...
			AssignmentsControllerHelper.setFgtCreateAsig(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.5_assignments.5_1.forms.CreateForm",
					"zuniformes.view.5_assignments.5_1.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogAsig: function () {
			...
			AssignmentsControllerHelper.setFgtUpdateAsig(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.5_assignments.5_1.forms.UpdateForm",
					"zuniformes.view.5_assignments.5_1.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedAsig: function () {
			this.createViewSettingsDialog("zuniformes.view.5_assignments.5_1.dialogs.SortDialog").open();
		},
		...
		onCreateDialogTaAsig: function () {
			...
			AssigSizesControllerHelper.setFgtCreateTaAsig(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.5_assignments.5_2.forms.CreateForm",
					"zuniformes.view.5_assignments.5_2.forms.CreateForm",
					this
				)
			);
		...
		handleSortBtnPressedTaAsig: function () {
			this.createViewSettingsDialog("zuniformes.view.5_assignments.5_2.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedTaAsig: function () {
			this.createViewSettingsDialog("zuniformes.view.5_assignments.5_2.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogEnc: function () {
			...
			InChargeControllerHelper.setFgtCreateEnc(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.6_in_charge.forms.CreateForm",
					"zuniformes.view.6_in_charge.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogEnc: function () {
			...
			InChargeControllerHelper.setFgtUpdateEnc(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.6_in_charge.forms.UpdateForm",
					"zuniformes.view.6_in_charge.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedEnc: function () {
			this.createViewSettingsDialog("zuniformes.view.6_in_charge.dialogs.SortDialog").open();
		},
		...
		onCreateDialogDoc: function () {
			...
			InfoDocumentsControllerHelper.setFgtCreateDoc(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.7_documents.7_1.forms.CreateForm",
					"zuniformes.view.7_documents.7_1.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogDoc: function () {
			...
			InfoDocumentsControllerHelper.setFgtUpdateDoc(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.7_documents.7_1.forms.UpdateForm",
					"zuniformes.view.7_documents.7_1.forms.UpdateForm",
					this
				)
			);
		...
		onCreateDialogRot: function () {
			...
			RotationsControllerHelper.setFgtCreateRot(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.8_rotations.8_1.forms.CreateForm",
					"zuniformes.view.8_rotations.8_1.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogRot: function () {
			...
			RotationsControllerHelper.setFgtUpdateRot(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.8_rotations.8_1.forms.UpdateForm",
					"zuniformes.view.8_rotations.8_1.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedRot: function () {
			this.createViewSettingsDialog("zuniformes.view.8_rotations.8_1.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedRot: function () {
			this.createViewSettingsDialog("zuniformes.view.8_rotations.8_1.dialogs.FilterDialog").open();
		},
		...
		onCreateDialogUsu: function () {
			...
			UsersControllerHelper.setFgtCreateUsu(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.9_users.9_1.forms.CreateForm",
					"zuniformes.view.9_users.9_1.forms.CreateForm",
					this
				)
			);
		...
		handleSortBtnPressedUsu: function () {
			this.createViewSettingsDialog("zuniformes.view.9_users.9_1.dialogs.SortDialog").open();
		},
		...
		onCreateDialogRol: function () {
			...
			RolesControllerHelper.setFgtCreateRol(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.9_users.9_2.forms.CreateForm",
					"zuniformes.view.9_users.9_2.forms.CreateForm",
					this
				)
			);
		...
		onUpdateDialogRol: function () {
			...
			RolesControllerHelper.setFgtUpdateRol(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.9_users.9_2.forms.UpdateForm",
					"zuniformes.view.9_users.9_2.forms.UpdateForm",
					this
				)
			);
		...
		handleSortBtnPressedRol: function () {
			this.createViewSettingsDialog("zuniformes.view.9_users.9_2.dialogs.SortDialog").open();
		},
		...
		onCreateDialogPer: function () {
			...
			PermissionsControllerHelper.setFgtCreatePer(
				sap.ui.xmlfragment(
					this.getView().getId() + "-zuniformes.view.9_users.9_3.forms.CreateForm",
					"zuniformes.view.9_users.9_3.forms.CreateForm",
					this
				)
			);
		...
		handleSortBtnPressedPer: function () {
			this.createViewSettingsDialog("zuniformes.view.9_users.9_3.dialogs.SortDialog").open();
		},
		...
		handleFilterBtnPressedPer: function () {
			this.createViewSettingsDialog("zuniformes.view.9_users.9_3.dialogs.FilterDialog").open();
		},
